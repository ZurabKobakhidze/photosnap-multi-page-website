...
export { default as BetaDestop} from "./shared/desktop/bg-beta.jpg";
export { default as BetaTablet} from "./shared/tablet/bg-beta.jpg";
export { default as PricingHeroMobile} from "./pricing/mobile/hero.jpg";
export { default as PricingHeroTablet} from "./pricing/tablet/hero.jpg";
export { default as PricingHeroDesktop} from "./pricing/desktop/hero.jpg";
