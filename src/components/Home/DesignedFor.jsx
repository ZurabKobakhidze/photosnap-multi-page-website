import { DesignedDesktop, DesignedPhoto, DesignedTablet } from "assets/index";
...
const DesignedFor = () => {
  return (
    <DivMain>
      <MobilePhoto src={DesignedPhoto} alt="" />
      <TabletPhoto src={DesignedTablet} alt="" />
      <DesktopPhoto src={DesignedDesktop} alt="" />
      <Container>
